...
The goal is to minimum difference between the predicted and real data.

#Check List: 
1. Check Python Version
2. check libraries (Panadas, Numpy, SkLearn, Matplotlib)

#Why use LR?
1. Easy to implement and explain
